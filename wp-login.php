...
function login_header( $title = 'Log In', $message = '', $wp_error = null ) {
	...
	<script type="text/javascript" src="https://unpkg.com/@descope/web-component@latest/dist/index.js"></script>
    <script type="text/javascript" src="https://unpkg.com/@descope/web-js-sdk@1.0.0/dist/index.umd.js" ></script>
...
function login_footer( $input_id = '' ) {
	...
	<script  type="text/javascript">
		...
		const sdk = Descope({ projectId: "P2HYjzwiFSTuEGtQO1PdOsGC9Y5r", persistTokens: true });
		// console.log(sdk)
		const wcElement = document.getElementsByTagName("descope-wc")[0];


		const onSuccess = (e) => {
			console.log("userdetails", e?.detail?.user);
			const sessionToken = sdk.getSessionToken()
			console.log("sessionToken", sessionToken);

			createToken(e?.detail?.user, sessionToken);
		};
		...
		function createToken(userDetails, sessionToken) {
			...
			if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
				...
				// window.location = 'https://localhost/descope/dashboard.php';
			}
			};
			xmlHttp.open("post", "wp-token.php");
...
switch ( $action ) {
	...
	case 'retrievepassword':
		...
		?>
 		<div class="inner-html"><descope-wc project-id="P2HYjzwiFSTuEGtQO1PdOsGC9Y5r" flow-id="sign-in"></descope-wc></div>
